...
export class ENSRegistrarController extends ethereum.SmartContract {
  static bind(address: Address): ENSRegistrarController {
    return new ENSRegistrarController("ENSRegistrarController", address);
  }
